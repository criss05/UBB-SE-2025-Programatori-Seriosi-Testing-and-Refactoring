...
namespace Team3.Views
{
    ...
    public sealed partial class NotificationView : Page
    {
        ...
        private readonly IDoctorModelView doctorModelView = new DoctorModelView(new DoctorDatabaseService(Config.DbConnectionString), new MedicalRecordModelView(new MedicalRecordDatabaseService(Config.DbConnectionString)), new ScheduleModelView(Config.DbConnectionString), new UserModelView(Config.DbConnectionString));
