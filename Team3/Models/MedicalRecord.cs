...
public class MedicalRecord
{
    ...
    public MedicalRecord(int doctorId, int patientId, DateTime medicalRecordDateTime)
    {
    ...
    {
        return $"MedicalRecord(Doctor ID : {this.DoctorId}, Patient ID: {this.PatientId}, MedicalRecordDateTime: {this.MedicalRecordDateTime})";
    }
}
